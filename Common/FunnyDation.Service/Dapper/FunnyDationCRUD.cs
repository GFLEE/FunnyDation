...
namespace FunnyDation.Service
{
    /// <summary>
    /// Main class for Dapper.SimpleCRUD extensions
    /// </summary>
    public static partial class FunnyDationCRUD
    {

        static FunnyDationCRUD()
        {
            SetDialect(_dialect);
        }
        ...
        public class TableNameResolver : ITableNameResolver
        {
            public virtual string ResolveTableName(Type type)
            {
                ...
                if (tableattr != null)
                {
                    ...
                    {
                        throw new Exception(ex.Message); //Schema doesn't exist on this attribute.
                    }
                }
